{
  inputs =
    let
      version = "1.10.0";
system = "x86_64-linux";
devenv_root = "/home/elliancarlos/Projects/aoc-2025";
devenv_dotfile = "/home/elliancarlos/Projects/aoc-2025/.devenv";
devenv_dotfile_path = ./.devenv;
devenv_tmpdir = "/run/user/1000";
devenv_runtime = "/run/user/1000/devenv-746fa6f";
devenv_istesting = false;
devenv_direnvrc_latest_version = 1;
container_name = null;
active_profiles = [ ];
hostname = "nixos";
username = "elliancarlos";
git_root = "/home/elliancarlos/Projects/aoc-2025";
